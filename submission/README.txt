...
The canonical committed outputs were generated by GitHub Actions on Linux
x86_64 with Python 3.11.16. KNN has frequent exact-distance boundary ties, so its final
...
Use the committed Linux tables for repeated report numbers. The full-versus-
size-only conclusion is unchanged by the order stress test.
